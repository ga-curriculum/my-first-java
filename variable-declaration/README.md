# ![[tktk Module Name] - tktk Microlesson Name](./assets/variable-declaration.png)

**Learning objective:** By the end of this lesson, students will be able to write the main Java method. 
